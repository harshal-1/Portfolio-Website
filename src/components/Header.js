        ...
        <div className={`${showMenu ? "nav__menu show-menu" : "nav__menu"}`}>
          <div className="nav__data">
            ...
            <div className="header__socials">
              <a href="https://twitter.com/Harshal__Rajput" className="header__social-link">
                <FaTwitter />
              </a>
              <a href="https://www.linkedin.com/in/harshal-rajput-94755a228/" className="header__social-link">
                <FaLinkedin />
              </a>
            </div>
          </div>
